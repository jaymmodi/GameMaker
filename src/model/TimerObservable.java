...
/** 
 *  This class acts as the TimerObservable, it notifies it's observers to perform some events.
 */
public class TimerObservable extends Observable {
	...
	/*
	 * Main function which executes on every event generated by timer. 
	 */
